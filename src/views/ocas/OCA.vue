    ...
    <SimpleSection ref="relevants" title="Productos más relevantes" subtitle="">
        <template v-if="!gallery_is_loading" v-slot:body>
            ...
            <div v-else class="flex justify-content--center">
                <span>No hay productos relevantes.</span>
                <Button @on_click="refresh_products" text="Actualizar" color="black" />
            </div>
...
export default {
    ...
    methods:{
        async get_relevant_products(){
            ...
            try {
                this.relevant_products = JSON.parse(localStorage.getItem("relevant_products"))
                ...
                if(this.relevant_products){
                    ...
                    let response = await fetch("https://alpha.tamps.cinvestav.mx/api/ratings/relevants",{
                        method:"GET",
                        // mode:"no-cors"
                    })
                        ...
                        this.is_loading.push(true)
                            ...
                            if(product["extension"] != "zip")  {
                                this.relevant_products.push({
                                    ...
                                    "view":`https://muyal.tamps.cinvestav.mx/OCA/default/formulario/visualizador/${product_id}`,
                    ...
                    localStorage.setItem("relevant_products",JSON.stringify(this.relevant_products))
                    this.gallery_is_loading = false;
                }
        ...
        on_click(){
            window.location.assign("https://muyal.tamps.cinvestav.mx/OCA/default/")
        }, 
